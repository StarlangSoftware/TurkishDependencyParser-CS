...
{
    /**
     * <summary>Enumerator class for Stanford Dependency tags</summary>
     */
    public enum StanfordDependencyType
    {
        ...
        POBJ, POSS, POSSESSIVE, PRECONJ, PREDET, PREP, PREPC, PRT, PUNCT, QUANTMOD, RCMOD, REF, ROOT, TMOD, VMOD, XCOMP, XSUBJ, NONE
    }
}